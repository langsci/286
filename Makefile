...
main.snd: main.bbl
	...
	sed -i 's/.*Groupe*//' main.adx
	sed -i 's/.*ASALE*//' main.adx
	sed -i 's/.*Estudis*//' main.adx
	sed -i 's/.*RAE*//' main.adx
	sed -i 's/.*grammatica*//' main.adx
	sed -i 's/.*Grammatici*//' main.adx
	sed -i 's/.*constructione*//' main.adx
	sed -i 's/.*soloecismo*//' main.adx
	sed -i 's/.*Fragmente*//' main.adx
	sed -i 's/.*Herodotum*//' main.adx
	sed -i 's/.*Opuscula*//' main.adx
	sed -i 's/.*Posterior*//' main.adx
	sed -i 's/.*sophistici*//' main.adx
	sed -i 's/.*Tractatus*//' main.adx
	sed -i 's/\\MakeCapital//' main.adx
	python3 fixindex.py
	mv mainmod.adx main.adx
	makeindex -o main.and main.adx
	makeindex -o main.lnd main.ldx
	cat indexextra.txt >> main.sdx
