...
\epigramsource{(\citealt[11]{firth_synopsis_1957})}
...
\begin{tikzpicture}
    ...
    []
    \end{axis}
    \caption{Ngram of \textit{all of a sudden}} %%\url{https://books.google.com/ngrams/graph?content=all+of+a+sudden & year_start=1800 & year_end=2000 & corpus=15 & smoothing=3 & share= & direct_url=t1%3B%2Call%20of%20a%20sudden%3B%2Cc0}}
    \label{fig:6:1}
\end{figure}

\begin{figure}
\caption{Ngram of \textit{kick the bucket}} %%\url{https://books.google.com/ngrams/graph?content=kick+the+bucket & year_start=1800 & year_end=2000 & corpus=15 & smoothing=3 & share= & direct_url=t1%3B%2Ckick%20the%20bucket%3B%2Cc0}
\label{fig:6:2}
\end{figure}

\begin{figure}
\caption{Ngram of \textit{in a jiffy}} %%\url{https://books.google.com/ngrams/graph?content=in+a+jiffy & year_start=1800 & year_end=2000 & corpus=15 & smoothing=3 & share= & direct_url=t1%3B%2Cin%20a%20jiffy%3B%2Cc0}}
\label{fig:6:3}
\end{figure}
...
In contrast to the prevailing linguistic view that the rules of language are acquired and then applied to the lexicon to generate grammatically correct novel utterances, according to the \is{usage-based}usage-based view, which aligns well with grammaticalization theory,\footnote{See \citet{kibbee_evolution_2010} for a detailed comparison of the usage-based grammaticalization theory with that of \is{generative grammar}generative grammar.}
